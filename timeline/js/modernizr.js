...
window.Modernizr = function(e, t, n) {
    ...
    function u() {
        m.input = function(n) {
            for (var r = 0,
                     o = n.length; o > r; r++) M[n[r]] = n[r] in E;
            ...
            m.inputtypes = function(e) {
                for (var r, o, a, i = 0,
                    ...
                    r = "text" !== E.type,
                r && (E.value = w, E.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && E.style.WebkitAppearance !== n ? (g.appendChild(E), a = t.defaultView, r = a.getComputedStyle && "textfield" !== a.getComputedStyle(E, null).WebkitAppearance && 0 !== E.offsetHeight, g.removeChild(E)) : /^(search|tel)$/.test(o) || (r = /^(url|email)$/.test(o) ? E.checkValidity && E.checkValidity() === !1 : E.value != w)),
                    P[e[i]] = !!r;
                return P
    ...
    var f, d, p = "2.8.3",
        ...
        D = {}.hasOwnProperty;
    d = a(D, "undefined") || a(D.call, "undefined") ?
        function(e, t) {
    ...
    function(e, t, n) {
        ...
        function s(e, n, r, o, a, s, l) {
            ...
            1 === T[n] && (g = 1, T[n] = []),
                ...
                v.splice(o, 0, b),
            "img" != e && (g || 2 === T[n] ? (w.insertBefore(f, E ? null: h), m(u, l)) : T[n].push(f))
        }
        function l(e, t, n, r, a) {
            return y = 0,
                t = t || "j",
                o(e) ? s("c" == t ? S: x, e, t, this.i++, n, r, a) : (v.splice(this.i++, 0, e), 1 == v.length && c()),
                this
        }
        function u() {
            var e = d;
